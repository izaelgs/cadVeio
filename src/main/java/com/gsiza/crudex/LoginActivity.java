        ...
        entrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (v != null){
                    ...
                    Toast.makeText(LoginActivity.this, "Login sucedido mano", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(LoginActivity.this, "escreve alguma coisa ae fml", Toast.LENGTH_LONG).show();
                }
