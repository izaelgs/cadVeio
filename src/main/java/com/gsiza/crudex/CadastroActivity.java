...
public class CadastroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        salvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(nomes.isEmpty()){
                    ...
                    Toast.makeText(CadastroActivity.this, "Veio cadastrado com sucesso", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(CadastroActivity.this, "Veio atualizado com sucesso", Toast.LENGTH_LONG).show();
        ...
        excluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ident.isEmpty()){
                    Toast.makeText(CadastroActivity.this, "Náo é possível excluir o vento, otario",
                    ...
                    Toast.makeText(CadastroActivity.this, "Veio sabugado com sucesso", Toast.LENGTH_LONG).show();
    ...
    public void listarVeios(){
        ...
        adapter = new ArrayAdapter<String>(CadastroActivity.this, android.R.layout.simple_list_item_1, arrayList);
